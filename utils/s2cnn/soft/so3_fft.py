...
import torch
import torch.cuda
from utils.s2cnn.utils.decorator import cached_dirpklgz


# inspired by https://gist.github.com/szagoruyko/89f83b6f5f4833d3c8adf81ee49f22a8

# Numpy 中 fft() 与 rfft() 的区别：numpy.fft.fft： Compute the one-dimensional discrete Fourier Transform.，即计算一维离散傅里叶变换。
# numpy.fft.rfft 则是：Compute the one-dimensional discrete Fourier Transform for real input. 计算实数输入的一维离散傅里叶变换。
...
'''
    import utils.s2cnn.utils.cuda as cuda_utils

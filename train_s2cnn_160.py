...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet_new, cfg_re50
...
from models.retinaface_s2cnn_160 import RetinaFace_resNet4 as RetinaFace
...
parser.add_argument('--save_folder', default='/nfs/volume-365-4/miaojingbo/weight/weight_4020_concat_se_cm_res/', help='Location to save checkpoint models')
